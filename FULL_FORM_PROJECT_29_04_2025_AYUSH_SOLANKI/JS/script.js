...
var ON = true;
var IMAGES = document.getElementsByClassName("bulb");
setInterval(function()
{
    for (var i = 0; i < IMAGES.length; i++)
        ...
        if (ON==true)
        {
            IMAGES[i].src = "IMAGES/img_on.png";
        } 
        else 
        {
            IMAGES[i].src = "IMAGES/img_of.png";
        }
    }
    ON = !ON;
},500);
...
function f()
{
    ...
    if (current_hours>=4 && current_hours<12)
    {
        document.getElementById("show_timer_msg").innerText="GOOD MORNING";
        document.getElementById("show_timer_msg").style.color="red";
        document.getElementById("images").src="IMAGES/sun.jpg";
    }
    else if (current_hours>=12 && current_hours<16)
    {
        document.getElementById("show_timer_msg").innerText="GOOD AFTERNOON";
        document.getElementById("show_timer_msg").style.color="orange";
        document.getElementById("images").src="IMAGES/good_afternnon.jpg";
    }
    else if (current_hours>=16 && current_hours<19)
    {
        document.getElementById("show_timer_msg").innerText="GOOD EVENINIG";
        document.getElementById("show_timer_msg").style.color="deeppink";
        document.getElementById("images").src="IMAGES/good_evenning.webp";
    }
    else
    {
        document.getElementById("show_timer_msg").innerText="GOOD NIGHT";
        document.getElementById("show_timer_msg").style.color="black";
        document.getElementById("images").src="IMAGES/good_night.jpg";
    }
    var t = 10;
    document.getElementById("show_min").innerText+=t+":";
    var time = t-1;
    var second = 59;
    document.getElementById("show_second").innerText+="00"
    var d = setInterval(function ()
    {
    if(time < 10)
    {
        document.getElementById("show_min").innerText = "0" + time + ":";
    }
    else
    {
        document.getElementById("show_min").innerText = time + ":";
    }
    if(second < 10 && time == 0)
    {
        document.getElementById("show_second").innerText = "0" + second;
        document.getElementById("show_min").style.color="red";
        document.getElementById("show_second").style.color="red";   
        document.getElementById("show_timer_error").innerText="Remaing Time Left 0"+second;
        document.getElementById("show_timer_error").style.color="red";             
    }
    else
    {
        document.getElementById("show_second").innerText = second;
    }
    if (second<10)
    {
        document.getElementById("show_second").innerText = "0" + second;    
    ...
    if (time < 0)
    {
        // document.getElementById("show_min").innerText = "00:";
        // document.getElementById("show_second").innerText = "00";
...
function check_dob()
{
    ...
    if (DOB1=="")
    {
        document.getElementById("date_id").style.border="3px solid red"; 
        TOB_1=false;  
    }
    else
    {
        document.getElementById("dob_show_msg").innerText="";
        document.getElementById("date_id").style.border="3px solid green"; 
        DOB_1=true;
    }
    checksumbit();
}
...
function check_images()
{
    ...
    if (IMAGESS=="") 
    {
        document.getElementById("images_id").style.border="3px solid red"; 
        IMAGES_1=false;   
    }
    else
    {
        document.getElementById("images_show_msg").innerText="";
        document.getElementById("images_id").style.border="3px solid green";  
        IMAGES_1 = true; 
    }
    checksumbit();
}
...
function check_address()
{
    ...
    if (ADDRESS1=="")
    {
        document.getElementById("add_id").style.border="3px solid red";
        document.getElementById("add_show_msg").innerText="plz fill address";
    ...
    {
        document.getElementById("add_id").style.border="3px solid green";
...
function check_city()
{
    ...
    if (CITY1=="s_c")
    {
        document.getElementById("city_id").style.border="3px solid red";
        document.getElementById("city_show_msg").innerText="plz select city"; 
        CITY_1=false;   
    }
    else
    {
        document.getElementById("city_id").style.border="3px solid green";
...
function check_captcha()
{
    ...
    if (USER_INPUT=="") 
    {
        ...
        document.getElementById("user_input").style.border="3px solid red";
    }
...
function ONKEYUP_CAPTCHA()
{
    ...
    else
    {
        ...
        document.getElementById("captcha_show_msg").style.color="green";
        document.getElementById("user_input").style.border="3px solid green"; 
    }
...
{
    //  console.log(
    //  ""+UNAME_1+""+ FNAME_1+""+ EMAIL_1 +""+ PASS_1 +""+ MOBILE_1 +""+ DOB_1+""+ TOB_1 +""+ IMAGES_1+""+ ADDRESS_1 +""+ CITY_1+""+ GENDER_1 +""+ HOBBY_1 +""+ CAPTCHA_1 );
